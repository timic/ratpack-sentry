...
public class RatpackHttpInterfaceBinding implements InterfaceBinding<RatpackHttpInterface> {
  ...
  @Override
  public void writeInterface(JsonGenerator generator, RatpackHttpInterface httpInterface) throws IOException {
  ...
  private void writeEnvironment(JsonGenerator generator, RatpackHttpInterface httpInterface) throws IOException {
    generator.writeStartObject();
  ...
  private void writeHeaders(JsonGenerator generator, Map<String, List<String>> headers) throws IOException {
